...
export const PATTERNS: ScamPattern[] = [
  ...
  },
  {
    ...
    aliases: ["KYC expiry call", "account block scam", "APK link scam", "customer care fraud"],
    tracks: ["money", "access"],
    channels: ["Voice call", "SMS", "WhatsApp"],
    stages: [
      { id: "alarm", label: "Urgent account alarm", signals: ["Told your account or SIM will be blocked today", "Told your KYC or PAN has expired"] },
      { id: "verify", label: "'Verification' demanded", signals: ["Asked for OTP, PIN, CVV or card number", "Asked to install an app or open a link"] },
      { id: "control", label: "Device or account control", signals: ["Asked to share screen or install AnyDesk/TeamViewer", "Asked to enter UPI PIN to 'receive' money"] },
    ],
    asks: ["OTP", "UPI PIN", "APK install", "Screen share"],
    nextMove: {
      alarm: "They will create urgency and ask you to 'verify' by sharing an OTP or opening a link.",
      verify: "They will ask you to install an app or share your screen so they can operate your bank app.",
      control: "They will move money out while you are still on the call, then ask you to wait.",
    },
    doNot: [
      "Banks never ask for OTP, PIN or CVV on a call. Hang up and call the number printed on your card.",
      "Do not install any app or open any link sent during the call.",
      "Do not share your screen with anyone claiming to be customer care.",
    ],
    advisoryCountries: ["India"],
    sources: [
      { label: "RBI — Be(A)ware booklet on modus operandi of frauds", url: "https://www.rbi.org.in/commonperson/English/Scripts/Notification.aspx?Id=3324", retrieved: "2026-09-04" },
      { label: "I4C / cybercrime.gov.in — advisories", url: "https://cybercrime.gov.in/Webform/Advisory.aspx", retrieved: "2026-09-04" },
    ],
  },
];
