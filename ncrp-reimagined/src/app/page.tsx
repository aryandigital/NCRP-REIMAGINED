  ...
  return (
    <div className="min-h-[100dvh] bg-paper" data-raksha-i18n="react">
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        <section className="section-glow bg-surface" lang="en">
          <div className="public-shell py-14 sm:py-20">
            <div className="reveal">
              <p className="kicker flex items-center gap-2"><Swords size={14} aria-hidden="true" /> New · Raksha Dojo</p>
            ...
            <div className="mt-6 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-start">
              <div className="reveal">
                <h2 className="display text-[1.8rem] text-ink sm:text-[2.4rem]">The scam calls <span className="text-[var(--saffron)]">you</span> before a real one does.</h2>
                <p className="mt-4 max-w-[52ch] text-[15px] leading-7 text-ink-soft">A live AI caller applies the pressure of a real fraud call in Hindi, Hinglish or English; you talk back; Call Shield lights each red flag; your coach scores the response and gives your family a shareable safety tip.</p>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  <Link key={card.t} href="/dojo" className={`reveal ${STAGGER[index]} group glow-card flex flex-col p-5 transition-shadow`}>
                    <p className="text-[15px] font-bold text-ink">{card.t}</p>
                    <p className="mt-2 text-sm italic leading-6 text-ink-soft">"{card.q}"</p>
                  </Link>
                ))}
              </div>
            </div>
