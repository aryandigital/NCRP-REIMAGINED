...
const HINDI: Record<string, string> = {
  ...
  "You do not need to finish this form to get help.": "मदद के लिए यह फॉर्म पूरा करना जरूरी नहीं।",
  "Call 112: immediate danger": "112 पर कॉल करें: तत्काल खतरा",
  "Call 1930: financial cyber fraud": "1930 पर कॉल करें: वित्तीय साइबर धोखाधड़ी",
  "Use fictional data only to explore possible scam patterns and suggested next steps. This prototype is not ready for real victim data. Guidance can be wrong; this is not an official report.": "केवल काल्पनिक डेटा का उपयोग करें। यह प्रोटोटाइप असली पीड़ित डेटा के लिए तैयार नहीं है। मार्गदर्शन गलत हो सकता है; यह कोई आधिकारिक रिपोर्ट नहीं है।",
  "Fictional text drafts are kept in this tab's session. Session storage is not a privacy guarantee; do not enter real victim data.": "काल्पनिक टेक्स्ट ड्राफ्ट इस टैब के सेशन में रखे जाते हैं। सेशन स्टोरेज गोपनीयता की गारंटी नहीं है; असली पीड़ित डेटा न डालें।",
  "Clear draft and image": "ड्राफ्ट और छवि हटाएं",
  "Screenshot (unavailable)": "स्क्रीनशॉट (अनुपलब्ध)",
  "Optional browser speech recognition may send audio to your browser's speech provider. On-device processing is not guaranteed. Language availability and accuracy vary.": "ब्राउज़र स्पीच रिकॉग्निशन ऑडियो स्पीच प्रोवाइडर को भेज सकता है। डिवाइस पर प्रोसेसिंग की गारंटी नहीं है। भाषा की उपलब्धता और सटीकता अलग-अलग होती है।",
  "Review the transcript before analysis. Starting recording may send audio to the speech provider; Raksha receives the transcript only when you submit it.": "विश्लेषण से पहले ट्रांसक्रिप्ट की समीक्षा करें। रिकॉर्डिंग शुरू करने पर ऑडियो स्पीच प्रोवाइडर को जा सकता है; Raksha ट्रांसक्रिप्ट केवल सबमिट करने पर प्राप्त करता है।",
  "Screenshot analysis is unavailable in this prototype.": "इस प्रोटोटाइप में स्क्रीनशॉट विश्लेषण उपलब्ध नहीं है।",
  "Image uploads are disabled because sensitive details in images cannot be reliably filtered. To try the demo, type or paste the visible message in Message using fictional names, numbers, and other details. Do not upload or transcribe real victim data.": "छवि अपलोड बंद है क्योंकि छवियों में संवेदनशील जानकारी फ़िल्टर नहीं की जा सकती। डेमो के लिए, Message में काल्पनिक नाम, नंबर और विवरण टाइप या पेस्ट करें। असली पीड़ित डेटा अपलोड या लिखें नहीं।",
  "Type or paste a fictional message": "काल्पनिक मैसेज टाइप या पेस्ट करें",
  "Private image hash remains a separate local-only demo. It does not analyse screenshot text or upload the image.": "प्राइवेट इमेज हैश एक अलग लोकल डेमो है। यह स्क्रीनशॉट टेक्स्ट का विश्लेषण नहीं करता और न ही छवि अपलोड करता है।",
  "Choose another image": "दूसरी छवि चुनें",
  "Choose image": "छवि चुनें",
  "Or drop an image here": "या यहां छवि छोड़ें",
  "PNG, JPG, WEBP, and HEIC up to 8 MB": "PNG, JPG, WEBP, और HEIC 8 MB तक",
  "Use a fictional test image only. This operation creates a perceptual fingerprint in your browser without uploading the image. It does not register protection or remove content. For real intimate-image protection, use the official StopNCII process.": "केवल काल्पनिक टेस्ट छवि का उपयोग करें। यह ऑपरेशन बिना अपलोड किए ब्राउज़र में फ़िंगरप्रिंट बनाता है। यह सुरक्षा पंजीकृत नहीं करता या सामग्री नहीं हटाता। असली छवि सुरक्षा के लिए StopNCII प्रक्रिया का उपयोग करें।",
  "Analysing the incident...": "घटना का विश्लेषण हो रहा है...",
  "Creating local fingerprint...": "लोकल फ़िंगरप्रिंट बनाया जा रहा है...",
  "Prototype limits": "प्रोटोटाइप की सीमाएं",
  "Fictional data only. Production authentication and security are not verified. Submitted text leaves your device, and automated redaction can miss details. Screenshot uploads are disabled. Local hashing is not a guarantee of privacy for real victims.": "केवल काल्पनिक डेटा। प्रोडक्शन प्रमाणीकरण और सुरक्षा सत्यापित नहीं है। सबमिट किया गया टेक्स्ट डिवाइस से बाहर जाता है। स्क्रीनशॉट अपलोड बंद है। लोकल हैशिंग असली पीड़ितों की गोपनीयता की गारंटी नहीं है।",
  "Choose a PNG, JPG, WEBP, or HEIC image.": "PNG, JPG, WEBP, या HEIC छवि चुनें।",
  "Keep the image under 8 MB.": "छवि 8 MB से कम रखें।",
  "Voice capture is not supported in this browser. Use the text box instead.": "इस ब्राउज़र में वॉयस कैप्चर समर्थित नहीं है। टेक्स्ट बॉक्स का उपयोग करें।",
  "Voice capture stopped. Check microphone access or continue by typing the transcript.": "वॉयस कैप्चर रुक गया। माइक्रोफ़ोन एक्सेस जांचें या ट्रांसक्रिप्ट टाइप करके जारी रखें।",
  "Voice capture could not start. Continue by typing instead.": "वॉयस कैप्चर शुरू नहीं हो सका। टाइप करके जारी रखें।",
  "Screenshot analysis is unavailable in this prototype. Use Message to type or paste fictional visible message text instead.": "इस प्रोटोटाइप में स्क्रीनशॉट विश्लेषण उपलब्ध नहीं है। Message में काल्पनिक दृश्यमान मैसेज टाइप या पेस्ट करें।",
  "Choose the image you want to fingerprint on this device.": "वह छवि चुनें जिसका इस डिवाइस पर फ़िंगरप्रिंट बनाना है।",
  "This image could not be fingerprinted in the browser.": "इस छवि का ब्राउज़र में फ़िंगरप्रिंट नहीं बन सका।",
  "Enter fictional message text or an example identifier to check.": "जांचने के लिए काल्पनिक मैसेज टेक्स्ट या उदाहरण पहचानकर्ता डालें।",
  "Analysis is unavailable right now. Use the example case or try again.": "अभी विश्लेषण उपलब्ध नहीं है। उदाहरण केस का उपयोग करें या पुनः प्रयास करें।",
  "High risk pattern": "उच्च जोखिम पैटर्न",
  "Needs caution": "सावधानी आवश्यक",
  "No confirmed match": "कोई पुष्टि नहीं",
  "Step 03 / analysis and confirmation": "चरण 03 / विश्लेषण और पुष्टि",
  "Confirm the facts you recognise. A pattern match is advisory, not proof of identity or guilt.": "जो तथ्य आपको पहचान में आएं उन्हें पुष्टि करें। पैटर्न मिलान एक सलाह है, पहचान या दोष का प्रमाण नहीं।",
  "Unknown cyber incident": "अज्ञात साइबर घटना",
  "We could not confirm this script in the pattern corpus. That does not mean it is safe.": "इस स्क्रिप्ट की पैटर्न कोष में पुष्टि नहीं हो सकी। इसका मतलब यह नहीं कि यह सुरक्षित है।",
  "Likely next move": "अगला संभावित कदम",
  "If this is already happening, do not pay or share another verification code.": "अगर यह हो रहा है, तो कोई भुगतान न करें और न ही कोई और वेरिफिकेशन कोड शेयर करें।",
  "Evidence signals": "साक्ष्य संकेत",
  "Why the pattern was flagged": "पैटर्न क्यों चिह्नित किया गया",
  "Incident graph": "घटना ग्राफ",
  "Only confirmed facts are included in recipient-specific response packets.": "केवल पुष्ट तथ्य प्राप्तकर्ता-विशिष्ट रिस्पॉन्स पैकेट में शामिल होते हैं।",
  "Case readiness": "केस तत्परता",
  "The remaining fields improve the bank and police packets. They are questions, not an AI score.": "शेष फ़ील्ड बैंक और पुलिस पैकेट को बेहतर बनाती हैं। ये प्रश्न हैं, AI स्कोर नहीं।",
  "Fill missing details": "लापता विवरण भरें",
  "Do not do this": "यह न करें",
  "What has already happened?": "अब तक क्या हो चुका?",
  "Choose the closest answer so the next screen orders containment before paperwork.": "सबसे करीबी उत्तर चुनें ताकि अगली स्क्रीन कागज़ी कार्रवाई से पहले रोकथाम का क्रम बताए।",
  "Money was transferred": "पैसा ट्रांसफर हो गया",
  "OTP or PIN was shared": "OTP या PIN शेयर किया गया",
  "An app was installed": "कोई ऐप इंस्टॉल किया गया",
  "Screen access was shared": "स्क्रीन एक्सेस शेयर किया गया",
  "Private images are involved": "निजी छवियां शामिल हैं",
  "Aadhaar or PAN was shared": "आधार या PAN शेयर किया गया",
  "Nothing has happened yet": "अभी तक कुछ नहीं हुआ",
  "No structured facts were extracted. This does not establish safety or rule out loss. Continue with the evidence you have.": "कोई संरचित तथ्य नहीं निकाले गए। इससे सुरक्षा साबित नहीं होती और न ही नुकसान से इनकार। जो साक्ष्य है उसके साथ आगे बढ़ें।",
  "Review every value before confirming. Leave unknown details blank; they will remain missing, not confirmed.": "पुष्टि से पहले हर मान की समीक्षा करें। अज्ञात विवरण खाली छोड़ें; वे लापता रहेंगे, पुष्टि नहीं।",
  "Confirmed": "पुष्टि हो गई",
  "Missing": "लापता",
  "Edited, not saved": "संपादित, सहेजा नहीं",
  "Needs review": "समीक्षा आवश्यक",
  "Facts could not be saved. Your edits are still here; please try again.": "तथ्य सहेजे नहीं जा सके। आपके संपादन यहां हैं; कृपया पुनः प्रयास करें।",
  "Review saved. Unknown details remain missing.": "समीक्षा सहेजी गई। अज्ञात विवरण अभी भी लापता हैं।",
  "Saving facts": "तथ्य सहेजे जा रहे हैं",
  "Confirm reviewed facts": "समीक्षित तथ्यों की पुष्टि करें",
  "This public example is read-only. Create a separate synthetic copy before reviewing facts, saving actions or preparing local packets. Use synthetic details only.": "यह सार्वजनिक उदाहरण केवल पढ़ने योग्य है। तथ्यों की समीक्षा, कार्रवाई सहेजने या लोकल पैकेट तैयार करने से पहले एक अलग सिंथेटिक कॉपी बनाएं। केवल सिंथेटिक विवरण का उपयोग करें।",
  "Creating example copy...": "उदाहरण कॉपी बनाई जा रही है...",
  "Create my example copy": "मेरी उदाहरण कॉपी बनाएं",
  "The example copy could not be opened. Please try again; the public example has not changed.": "उदाहरण कॉपी नहीं खुल सकी। कृपया पुनः प्रयास करें; सार्वजनिक उदाहरण नहीं बदला है।",
};
