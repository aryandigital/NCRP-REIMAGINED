...
function Base({ size = 24, className, title, children }: IconProps & { children: React.ReactNode }) {
  return (
...
export function BrandMark({ size = 40, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round" className={className} role="img" aria-label="Raksha">
...
export function IconRadar(props: IconProps) {
  return (
    <Base {...props}>
      ...
      <path d="M12 3.8 C 12.9 4.7 13.4 5.3 13.4 6.1 C 13.4 6.9 12.8 7.4 12 7.4 C 11.2 7.4 10.6 6.9 10.6 6.1 C 10.6 5.3 11.1 4.7 12 3.8 Z" fill="currentColor" stroke="none" />
    </Base>
  );
}
...
export function IconAlert(props: IconProps) {
  return (
    <Base {...props}>
      ...
      <circle cx="12" cy="15.9" r="0.6" fill="currentColor" />
    </Base>
  );
}
